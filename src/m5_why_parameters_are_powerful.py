...
def main():
    ...
    #better_draw_circles(rg.Point(59, 50), 3)
    #better_draw_circles(rg.Point(5,100), 6)
    #even_better_draw_circles(rg.Point(0, 0), 10, 5, 'blue', 8)
    #even_better_draw_circles(rg.Point(10,50), 20, 30, 'pink', 10)
    even_better_draw_circles(rg.Point(0, 0), 10, 20, 'blue', 8)
    even_better_draw_circles(rg.Point(100,0), 10, 20, 'blue', 8)
    even_better_draw_circles(rg.Point(-100, 0), 10, 20, 'red', 8)
    even_better_draw_circles(rg.Point(0,100), 10, 20, 'purple', 8)
    even_better_draw_circles(rg.Point(0, -100), 10, 20, 'purple', 8)
    window.update()
